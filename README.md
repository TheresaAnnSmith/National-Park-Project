...
There are many nuances in the way parks are spelled and punctuated, i.e "&" vs. "and." A good example is "Gates of the Artic National Park." There are extra spaces in that park name throughout some of my tables, so I'm going back through and making sure all the park names are a perfect match, so I can merge the tables and use "Park Name" as my primary key. 
